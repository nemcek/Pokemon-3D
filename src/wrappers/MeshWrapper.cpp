...
MeshWrapper::MeshWrapper(GLuint program_id, Loader *loader, const std::string &obj_file, const std::string &image_file, int count, glm::vec3 scale) {
    this->mesh = new Mesh(program_id, loader, obj_file, image_file);
