...
StreetLamp::StreetLamp(GLint program_id, Loader *loader, glm::vec3 position)
        : Terrain(program_id, loader, "models/objects/StreetLamp.obj", "models/textures/StreetLamp.tga", position,
                 0.0f, 0.0f, 0.0f, 0.7f) {
